	...
	<table class="tab-member" cellpadding="0" cellspacing="0">
	    ...
	    <tbody>
		    ...
		    <tr>
		    	...
		    	<td>
		    		<a href="${pageContext.request.contextPath }/ybhManageAction_editIncome.action?hname=<s:property value="#session.vts.map.hname"/>&year=<s:property value="#ls2.year"/>&intotal=<s:property value="#ls2.intotal"/>&injy=<s:property value="#ls2.injy"/>&inwork=<s:property value="#ls2.inwork"/>&incz=<s:property value="#ls2.incz"/>&inpersonal=<s:property value="#ls2.inpersonal"/>&fs=<s:property value="#ls2.fs"/>&fs1=<s:property value="#ls2.fs1"/>&fs2=<s:property value="#ls2.fs2"/>&fs3=<s:property value="#ls2.fs3"/>&fs4=<s:property value="#ls2.fs4"/>&fs5=<s:property value="#ls2.fs5"/>&vv=<s:property value="#ls2.v"/>&vv1=<s:property value="#ls2.v1"/>&vv2=<s:property value="#ls2.v2"/>&xxe=<s:property value="#ls2.xe"/>&bb=<s:property value="#ls2.b"/>&bb1=<s:property value="#ls2.b1"/>&bb2=<s:property value="#ls2.b2"/>&bb3=<s:property value="#ls2.b3"/>&bb4=<s:property value="#ls2.b4"/>&zlbz=<s:property value="#ls2.zlbz"/>&lzzj=<s:property value="#ls2.lzzj"/>&isv1=<s:property value="#ls2.isv1"/>&isv2=<s:property value="#ls2.isv2"/>&isv3=<s:property value="#ls2.isv3"/>&isv4=<s:property value="#ls2.isv4"/>&isv5=<s:property value="#ls2.isv5"/>">编辑</a>
		    	</td>
		    </tr>
		    </s:iterator>
	    </tbody>
