	...
	<table class="tab-member" cellpadding="0" cellspacing="0">
	    ...
	    <tbody>
		    ...
		    <tr>
		    	...
		    	<td>
		    		<s:if test="#session.vts.map.tpl==1">
		    		是
		    		</s:if>
		    		<s:else>
		    		否
		    	...
		    	<td>
		    		<a href="${pageContext.request.contextPath }/ybhManageAction_editIncome.action?hname=<s:property value="#session.vts.map.hname"/>&year=<s:property value="#ls2.year"/>&population=<s:property value="#session.vts.map.population"/>&labornum=<s:property value="#session.vts.map.labornum"/>&wlabornum=<s:property value="#session.vts.map.wlabornum"/>&fields=<s:property value="#session.vts.map.fields"/>&lzmj=<s:property value="#session.vts.map.lzmj"/>&intotal=<s:property value="#ls2.intotal"/>&injy=<s:property value="#ls2.injy"/>&inwork=<s:property value="#ls2.inwork"/>&incz=<s:property value="#ls2.incz"/>&lzzj=<s:property value="#ls2.lzzj"/>&inbz=<s:property value="#ls2.inbz"/>&zlbz=<s:property value="#ls2.zlbz"/>&isv1=<s:property value="#ls2.isv1"/>&isv2=<s:property value="#ls2.isv2"/>&isv3=<s:property value="#ls2.isv3"/>&isv4=<s:property value="#ls2.isv4"/>&isv5=<s:property value="#ls2.isv5"/>&isv6=<s:property value="#ls2.isv6"/>&inpersonal=<s:property value="#ls2.inpersonal"/>&dcause=<s:property value="#session.vts.map.dcause"/>&fs=<s:property value="#ls2.fs"/>&fs1=<s:property value="#ls2.fs1"/>&fs2=<s:property value="#ls2.fs2"/>&fs3=<s:property value="#ls2.fs3"/>&fs4=<s:property value="#ls2.fs4"/>&fs5=<s:property value="#ls2.fs5"/>&fs6=<s:property value="#ls2.fs6"/>&fs7=<s:property value="#ls2.fs7"/>&fs8=<s:property value="#ls2.fs8"/>&vv=<s:property value="#ls2.v"/>&vv1=<s:property value="#ls2.v1"/>&vv2=<s:property value="#ls2.v2"/>&xxe=<s:property value="#ls2.xe"/>&bb=<s:property value="#ls2.b"/>&bb1=<s:property value="#ls2.b1"/>&bb2=<s:property value="#ls2.b2"/>&bb3=<s:property value="#ls2.b3"/>&bb4=<s:property value="#ls2.b4"/>&ltp=<s:property value="#session.vts.map.tpl"/>">编辑</a>
		    	</td>
		    </tr>
		    </s:iterator>
	    </tbody>
