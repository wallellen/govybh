         ...
         <tbody id="splitpage">
			...
			<tr style="display:none;">
				...
				<s:else>
					...
					<td class="tabtd1">
						<a href="${pageContext.request.contextPath }/yearDataAction_editIncome.action?year=<s:property value="year"/>&curhm=<s:property value="#ls.hm"/>&hname=<s:property value="#ls.hname"/>">年数据录入</a>
					</td>
				</s:else>
			</tr>
			</s:iterator>
